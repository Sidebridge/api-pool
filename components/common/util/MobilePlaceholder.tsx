...
const MobilePlaceholder = () => {
  return (
    <div className="align-col text-center items-center md:hidden py-8 px-5 fixed top-0 left-0 w-screen h-screen bg-body z-[3000]">
      ...
      <AppIcon icon="MobileSoon" styles="mt-10 min-w-[300px]" />

      <h1 className={clsx("text-3xl mt-16", classes["header-text__bg"])}>
        Mobile Availability Not Ready Yet!
      </h1>
      <p className="mt-8 text-lg font-light text-grey-legacy">
        ...
        that on devices with bigger screens like a tablet or PC 💻
      </p>
    </div>
  );
};
